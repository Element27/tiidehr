  ...
  <>
    <Formik
      ...
      validate={(values) => {
        ...
        if (!currency) errors.currency = "This field is required";
        return errors;
      }}
    >
      {({
      ...
      <form className={styles.businessForm}>
         ...
         {errors.taxid && touched.taxid && (
              ...
              <CurrencySelectInput value={values.currency} name="currency" handleChange={handleChange} />
              {errors.currency && touched.currency && (
                <p className={style.errorText}>{errors.currency}</p>
              )} 
